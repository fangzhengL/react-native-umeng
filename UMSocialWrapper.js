...
const QQ = require('./img/QQ.png');
const SINA = require('./img/sinaWeiBo.png');

const DEFAULT_PLATFORM_ICONS = [QQ,SINA,WECHAT_SESSION, WECHAT_TIMELINE];
const DEFAULT_PLATFORMS = ['SocialPlatformQQ', 'SocialPlatformSina','SocialPlatformWechatSession', 'SocialPlatformWechatTimeLine'];
